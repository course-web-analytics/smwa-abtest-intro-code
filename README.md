# Social Media and Web Analytics: A/B Tests - Introduction
...
Contains the code associated with the lecture "ABtest - Intro".
...
```{bash, eval = FALSE}
git clone git@github.com:course-web-analytics/smwa-abtest-intro-code.git
```
